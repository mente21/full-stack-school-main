...
const ResultForm = ({
    ...
    // relatedData should contain exams, assignments, students
    const { exams, assignments, students } = relatedData || { exams: [], assignments: [], students: [] };
                    ...
                    >
                        ...
                        {assignments.map((assignment: { id: number; title: string }) => (
                            <option
                                value={assignment.id}
                                key={assignment.id}
                                selected={data?.assignmentId === assignment.id}
                            >
                                {assignment.title}
                            </option>
                        ))}
